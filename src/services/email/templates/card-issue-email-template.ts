...
export function CardIssueEmail(user: UserEntity, card: CardEntity): string {
    return `
                ...
                <tbody>
                  ...
                  <tr>
                    <td colspan="2" style="padding-bottom: 110px; color: #808080">
                      <p>
                        We are unable to charge your ${card.cardType} card with last four card no. : <b>${card.last4}</b> for your auto saving.
                        Please make sure you have sufficient balance on your card or cross check that your card is issuer operative.
