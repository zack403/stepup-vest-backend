...
export function ConfirmEmail(user: UserEntity, link): string {
    return `
                ...
                <tbody>
                  ...
                  <tr>
                    <td colspan="2" style="padding-bottom: 110px; color: #808080">
                      <p>
                      Thank you for creating your account on StepupVest.
                      </p>
  
                      <p>
                      For security purposes, please click the below link to verify your email address.
                      </p>
                    </td>
                  </tr>
                  <tr>
