...
export function CardNotReuseableEmail(user: UserEntity, request: any): string {
    return `
                ...
                <tbody>
                  ...
                  <tr>
                    <td colspan="2" style="padding-bottom: 110px; color: #808080">
                      <p>
                        We noticed that the new ${request.cardType} card you added with last four card no. : <b>${request.last4}</b>
                        is not reuseable, therefore we will be unable to charge it, please kindly update your card details or change it.
                      </p>
                    </td>
                  </tr>
                </tbody>
